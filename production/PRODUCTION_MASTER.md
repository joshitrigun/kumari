...
3.  **Environment:** Where an environment sheet (`E:`) is listed, use it as loose visual guidance for the setting — describe the space in your prompt; the `.svg` is just a reference sketch, not a required upload.
