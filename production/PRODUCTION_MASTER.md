...
| **03** | **COULD** | 361 – 720 | **Hands & Token:** Close action on board. | **C:** `shot03.svg` / **I:** `king.svg`, `taleju.svg` | Hands look human (5 fingers); token has a physical "weight." |
| **04** | **SHOULD** | 721 – 1200 | **Queen's Witness:** Peeking through lattice. | **C:** `shot04.svg` / **I:** `queen.svg` / **S:** `STYLE_ANCHOR.png` | Lattice cast geometric shadows on face; eyes show longing. |
| **05** | **MUST** | 1201 – 1752 | **Intimacy Peak:** Eyes meeting close-up. | **C:** `shot05.svg` / **I:** `king.svg`, `taleju.svg` | Sub-surface scattering on skin; liquid light ripples on faces. |
| **06** | **MUST** | 1753 – 2400 | **The Transgression:** Cold shift / Desire. | **C:** `shot06.svg` / **I:** `king.svg` | **CRITICAL:** Lighting shift must be a live transition, not a cut. |
| **07** | **COULD** | 2401 – 2712 | **Confrontation:** Reaching and recoiling. | **C:** `shot07.svg` / **I:** `king.svg`, `taleju.svg` | Taleju's movement is graceful even in fear; King looks obsessed. |
| **08** | **MUST** | 2713 – 3336 | **The Vanishing:** Dissolve / Token falls. | **C:** `shot08.svg` / **I:** `taleju.svg` | Dissolve is upward particles; token roll has realistic physics. |
| **09** | **COULD** | 3337 – 3840 | **Memory:** Flashback to smile. | **C:** `shot09.svg` / **I:** `taleju.svg` | Soft-focus bloom; saturation matches Act 1 warmth. |
| **10** | **SHOULD** | 3841 – 4320 | **Rain Transition:** King walks in rain. | **C:** `shot10.svg` / **E:** `rain_alley.svg` / **I:** `king.svg` | Rain looks like streaks, not noise; King's robes look damp. |
| **11** | **COULD** | 4321 – 4680 | **Dream Taleju:** Silhouette in mist. | **C:** `shot11.svg` / **I:** `taleju.svg` | Rain passes THROUGH the translucent silhouette. |
...
| **14** | **SHOULD** | 5713 – 6024 | **Dream Peak:** instruction / Tear. | **C:** `shot14.svg` / **I:** `king.svg` | Expression shift from pain to peace; single tear is visible. |
| **15** | **MUST** | 6025 – 6720 | **Kumari Appears:** Entrance of child. | **C:** `shot15.svg` / **I:** `kumari_child.svg` / **E:** `dawn_courtyard.svg` | Walk is a ritual "glide" (no vertical bob); aura is soft. |
